...
1. 先改 `BOUNDARY.md`
2. 如果 starter 拓扑要变化，先改 `governance/scaffold.manifest.json`
3. 再改 `governance/files.registry.json`
4. 再改 `governance/intent.routes.json`
5. 再改 `skills/review-skill/SKILL.md`
6. 最后改 `workflow.contract.json`、`objects/*.json` 和运行实例
