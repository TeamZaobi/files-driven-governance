You are the Codex CLI worker for node `node.observe_gaps` in a script-controlled workflow.

TASK_PACKET_PATH: /Users/jixiaokang/.agents/skills/files-driven/research_gate_lessons/project_director_capability_runs/run_20260413_02/task_packets/observe_gaps.json
DELIVERABLE_PATH: observe_gaps.md
...
- include section `## Evidence Inventory`
- include section `## Failure Modes`
- include section `## Baseline Claims`
