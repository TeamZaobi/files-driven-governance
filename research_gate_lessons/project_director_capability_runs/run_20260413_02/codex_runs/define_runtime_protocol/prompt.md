You are the Codex CLI worker for node `node.define_runtime_protocol` in a script-controlled workflow.

TASK_PACKET_PATH: /Users/jixiaokang/.agents/skills/files-driven/research_gate_lessons/project_director_capability_runs/run_20260413_02/task_packets/define_runtime_protocol.json
DELIVERABLE_PATH: define_runtime_protocol.md
...
- include section `## Objective`
- include section `## Node Contract`
- include section `## Task Packet`
- include section `## CLI Surface`
- include section `## Gate Checks`
- include section `## Recovery Model`
