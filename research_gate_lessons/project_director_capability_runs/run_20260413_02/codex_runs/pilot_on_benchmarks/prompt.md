You are the Codex CLI worker for node `node.pilot_on_benchmarks` in a script-controlled workflow.

TASK_PACKET_PATH: /Users/jixiaokang/.agents/skills/files-driven/research_gate_lessons/project_director_capability_runs/run_20260413_02/task_packets/pilot_on_benchmarks.json
DELIVERABLE_PATH: pilot_on_benchmarks.md
...
- include section `## Benchmark Matrix`
- include section `## Pilot Result`
- include section `## Residual Risks`
- include section `## Follow-up Checks`
