---
name: files-driven
description: 用于 AI-Native / AI-Driven 项目的治理与收口：当项目出现漂移、真源不清、改动边界失控，或需要 install / register / repair / audit 等最小动作时使用；必要时再下钻 capability_scope / project_scope / runtime_scope、入口规则 / 能力规则 / 项目规则 / 项目实体，并在 self-hosting 时走 capability-improve + Codex CLI 的受控执行路径。
---
